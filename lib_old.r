...
pocet_hlasu <- function(raw_xml) {
  
  cisloSchuze<-xpathApply(xmlRoot(raw_xml),path="count(//hlasovaniSenatu/hlasovaniSenatora/cisloSchuze)",xmlValue)
  cisloHlasovani<-xpathApply(xmlRoot(raw_xml),path="count(//hlasovaniSenatu/hlasovaniSenatora/cisloHlasovani)",xmlValue)
  volebniObdobi<-xpathApply(xmlRoot(raw_xml),path="count(//hlasovaniSenatu/hlasovaniSenatora/volebniObdobi)",xmlValue)
